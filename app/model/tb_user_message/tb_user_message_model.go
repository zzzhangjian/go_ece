...
// arModel is a active record design model for table tb_user_message operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_user_message.
	Table = "tb_user_message"
	// Model is the model object of tb_user_message.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_user_message.
	Columns = struct {
		Id          string //               
        UserId      string // 用户id        
        MessageId   string // 消息id        
        Status      string // 0:未读;1已读  
