...
// arModel is a active record design model for table tb_chain_blocks operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_chain_blocks.
	Table = "tb_chain_blocks"
	// Model is the model object of tb_chain_blocks.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_chain_blocks.
	Columns = struct {
		Id           string //                       
        UserId       string // 用户                  
        Tid          string // 交易号                
