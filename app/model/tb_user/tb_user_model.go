...
// arModel is a active record design model for table tb_user operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_user.
	Table = "tb_user"
	// Model is the model object of tb_user.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_user.
	Columns = struct {
		UserId            string // 用户ID         
        Username          string // 用户名         
        Mobile            string // 手机号         
        InviteCode        string // 邀请码         
        UserParentId      string // 推荐人         
        Email             string // 邮箱           
        GradeId           string // 用户级别 外键  
        Salt              string // 密码加盐       
        Password          string // 密码           
        SecurityPassword  string // 资金密码       
        Avatar            string // 头像           
        ProfitTotal       string // 总权益         
