...
// arModel is a active record design model for table exchange_currency operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of exchange_currency.
	Table = "exchange_currency"
	// Model is the model object of exchange_currency.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table exchange_currency.
	Columns = struct {
		Id          string //                          
        Currency    string // 币种                     
