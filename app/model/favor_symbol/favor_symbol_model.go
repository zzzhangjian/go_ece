...
// arModel is a active record design model for table favor_symbol operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of favor_symbol.
	Table = "favor_symbol"
	// Model is the model object of favor_symbol.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table favor_symbol.
	Columns = struct {
		Id          string // 主键      
        Symbol      string // 交易对    
        UserId      string // 用户id    
