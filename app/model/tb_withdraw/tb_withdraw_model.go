...
// arModel is a active record design model for table tb_withdraw operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_withdraw.
	Table = "tb_withdraw"
	// Model is the model object of tb_withdraw.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_withdraw.
	Columns = struct {
		Id             string //                       
        UserId         string // 用户ID                
        UserAccountId  string // 账户ID                
        Currency       string // 提现币种              
        FromAddress    string // 提出地址              
        Fee            string // 手续费                
        Amount         string // 提现金额              
        Total          string // 总额                  
        ToAddress      string // 提入地址              
        Txid           string // 提现交易hash          
        BlockNumber    string //                       
        Status         string // FAIL;PROCESS;SUCCESS  
        Approve        string // 审核状态              
        AasmStatus     string // FAIL;PROCESS;SUCCESS  
        Tid            string // 交易号                
        DoneAt         string // 完成时间              
        UpdateAt       string //                       
        CreateAt       string //
