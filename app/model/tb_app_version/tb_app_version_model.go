...
// arModel is a active record design model for table tb_app_version operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_app_version.
	Table = "tb_app_version"
	// Model is the model object of tb_app_version.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_app_version.
	Columns = struct {
		Id           string //               
        VersionNo    string // 版本号        
        VersionType  string // IOS,ANDROID   
        Forced       string // 是否强制升级  
        DownloadUrl  string // 版本地址      
        Remarks      string // 版本描述信息  
        UpdateAt     string //               
        CreateAt     string //
	}{
		Id:          "id",            
