...
// arModel is a active record design model for table tb_user_account operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_user_account.
	Table = "tb_user_account"
	// Model is the model object of tb_user_account.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_user_account.
	Columns = struct {
		Id             string //                                                  
        UserId         string // 所属用户                                         
        AccountSymbol  string // 账户类型  wallet, consume, pool, digital, token  
        Currency       string // 币种USDT;ECUSDT;ECE;IECE                         
        Account        string // 钱包账户地址                                     
        ErcAccount     string // 钱包ERC账户地址                                  
        Balance        string // 钱包账户余额                                     
        PriKey         string // 私钥                                             
        ErcPriKey      string // erc20私钥                                        
        InAmount       string // 账户入账总额                                     
        OutAmount      string // 账户出账总额                                     
        ...
        Currency:      "currency",        
        Account:       "account",         
        ErcAccount:    "erc_account",     
        Balance:       "balance",         
        PriKey:        "pri_key",         
        ErcPriKey:     "erc_pri_key",     
        InAmount:      "in_amount",       
