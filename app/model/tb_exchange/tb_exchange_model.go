...
// arModel is a active record design model for table tb_exchange operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_exchange.
	Table = "tb_exchange"
	// Model is the model object of tb_exchange.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_exchange.
	Columns = struct {
		Id            string //                       
        UserId        string // 用户ID                
        Ticker        string // 交易对                
        TradeLogFrom  string // 划出交易ID            
        TradeLogTo    string // 划入交易ID            
        Cost          string // 兑换花费              
        Price         string // 兑换价格              
        Amount        string // 兑换数量 到账金额     
        ...
        UserId:       "user_id",         
        Ticker:       "ticker",          
        TradeLogFrom: "trade_log_from",  
        TradeLogTo:   "trade_log_to",    
        Cost:         "cost",            
        Price:        "price",           
        Amount:       "amount",          
        Status:       "status",          
