...
// arModel is a active record design model for table goods_kline_min60_info operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of goods_kline_min60_info.
	Table = "goods_kline_min60_info"
	// Model is the model object of goods_kline_min60_info.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table goods_kline_min60_info.
	Columns = struct {
		Id               string //                   
        Code             string // 代码              
        Period           string // 期数 20180606     
        Volume           string // 成交量            
        Price            string // 当前价            
        OpeningPrice     string // 前一刻开盘价      
        ClosingPrice     string // 前一刻收盘价      
        PreClosingPrice  string // 昨收盘价          
        HighestPrice     string // 最高价            
        LowestPrice      string // 最低价            
        DateYmd          string // 日期              
        Date             string // 日期时间          
        CreateTime       string // 创建时间          
        IsDeleted        string // 1:删除，0:未删除  
        Timestamp        string //
	}{
		Id:              "id",                 
        Code:            "code",               
        ...
        PreClosingPrice: "pre_closing_price",  
