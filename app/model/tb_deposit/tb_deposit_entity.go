...
// Entity is the golang structure for table tb_deposit.
type Entity struct {
    Id            uint64      `orm:"id,primary"              json:"id"`              //                       
    UserId        int64       `orm:"user_id"                 json:"user_id"`         //                       
    UserAccountId int64       `orm:"user_account_id,primary" json:"user_account_id"` //                       
    ToAddress     string      `orm:"to_address"              json:"to_address"`      // 钱包地址              
    FromAddress   string      `orm:"from_address"            json:"from_address"`    // 充值地址 来源         
    CoinName      string      `orm:"coin_name"               json:"coin_name"`       // 币种                  
    Fee           float64     `orm:"fee"                     json:"fee"`             // 手续费                
    Amount        float64     `orm:"amount"                  json:"amount"`          // 充值金额              
    ...
    BlockNumber   int64       `orm:"block_number"            json:"block_number"`    // 区块号                
