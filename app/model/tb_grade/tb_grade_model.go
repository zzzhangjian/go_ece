...
// arModel is a active record design model for table tb_grade operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_grade.
	Table = "tb_grade"
	// Model is the model object of tb_grade.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_grade.
	Columns = struct {
		Id          string // 主键      
        GradeLevel  string // 级别      
        GradeName   string // 级别名称  
        SalesLimit  string // 业绩要求  
        ProfitRate  string // 奖励率
	}{
		Id:         "id",           
