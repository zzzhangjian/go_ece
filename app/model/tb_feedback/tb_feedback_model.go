...
// arModel is a active record design model for table tb_feedback operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_feedback.
	Table = "tb_feedback"
	// Model is the model object of tb_feedback.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_feedback.
	Columns = struct {
		Id        string //                           
        UserId    string //                           
        Title     string //                           
        Content   string //                           
        Images    string // 图片,以;隔开,最多6张图片  
        Reply     string //                           
        UpdateAt  string //                           
        CreateAt  string //                           
        Deleted   string //
