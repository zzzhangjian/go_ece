...
// arModel is a active record design model for table sys_dict operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_dict.
	Table = "sys_dict"
	// Model is the model object of sys_dict.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sys_dict.
	Columns = struct {
		Id        string //                                
        Name      string // 字典名称                       
        Type      string // 字典类型                       
