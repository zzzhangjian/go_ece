...
// arModel is a active record design model for table tb_deposit operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_deposit.
	Table = "tb_deposit"
	// Model is the model object of tb_deposit.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_deposit.
	Columns = struct {
		Id             string //                       
        UserId         string //                       
        UserAccountId  string //                       
        ToAddress      string // 钱包地址              
        FromAddress    string // 充值地址 来源         
        CoinName       string // 币种                  
        Fee            string // 手续费                
        Amount         string // 充值金额              
        Total          string // 总额                  
