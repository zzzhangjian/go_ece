...
// arModel is a active record design model for table exchange_currency_chain operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of exchange_currency_chain.
	Table = "exchange_currency_chain"
	// Model is the model object of exchange_currency_chain.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table exchange_currency_chain.
	Columns = struct {
		Id                       string //                                                                                                
        Chain                    string // 链名称                                                                                         
