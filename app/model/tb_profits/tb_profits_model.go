...
// arModel is a active record design model for table tb_profits operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_profits.
	Table = "tb_profits"
	// Model is the model object of tb_profits.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_profits.
	Columns = struct {
		Id             string //                                                  
        Tid            string // 发放收益流水ID                                   
        UserId         string // 获得收益的用户                                   
        UserAccountId  string // 账户                                             
        UserMachineId  string // 矿机ID                                           
        SourceUserId   string // 来源用户ID                                       
        Type           string // machine,block,manage,fans,achievement,recommend  
