...
// arModel is a active record design model for table goods_orghis_info operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of goods_orghis_info.
	Table = "goods_orghis_info"
	// Model is the model object of goods_orghis_info.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table goods_orghis_info.
	Columns = struct {
		Id         string //                
        Code       string // 交易对         
        Date       string // 日期           
