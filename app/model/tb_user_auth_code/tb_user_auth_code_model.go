...
// arModel is a active record design model for table tb_user_auth_code operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_user_auth_code.
	Table = "tb_user_auth_code"
	// Model is the model object of tb_user_auth_code.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_user_auth_code.
	Columns = struct {
		Id          string // 主键         
        CodeKey     string // 验证码KEY    
        CodeValue   string // 验证码VALUE  
