...
// arModel is a active record design model for table tb_sweep operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_sweep.
	Table = "tb_sweep"
	// Model is the model object of tb_sweep.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_sweep.
	Columns = struct {
		Id              string //                       
        Txid            string // 交易hash              
        BlockNumber     string //                       
        CoinName        string // 币种 omni,erc20       
        CollectAddress  string // 归集地址              
        FromAddress     string // 用户地址              
        Fee             string // 手续费                
        Amount          string // 到账金额              
        Total           string // 总额                  
