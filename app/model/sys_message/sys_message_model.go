...
// arModel is a active record design model for table sys_message operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_message.
	Table = "sys_message"
	// Model is the model object of sys_message.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sys_message.
	Columns = struct {
		Id              string //           
