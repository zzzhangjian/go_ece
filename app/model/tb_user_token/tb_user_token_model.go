...
// arModel is a active record design model for table tb_user_token operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_user_token.
	Table = "tb_user_token"
	// Model is the model object of tb_user_token.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_user_token.
	Columns = struct {
		UserId      string //           
        Token       string // token     
