...
// arModel is a active record design model for table tb_posts operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_posts.
	Table = "tb_posts"
	// Model is the model object of tb_posts.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_posts.
	Columns = struct {
		Id           string //                   
        PublishName  string // 发布人            
        PublishTime  string // 发布时间          
        PostType     string // BANNER,NOTICE,AD  
        Title        string // 标题              
        Url          string // 跳转路径          
        Banner       string // 图片              
        SubContent   string // 简述              
        Content      string // 详情              
        UpdateAt     string //                   
        CreateAt     string //
	}{
