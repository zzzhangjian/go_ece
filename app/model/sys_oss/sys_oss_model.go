...
// arModel is a active record design model for table sys_oss operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_oss.
	Table = "sys_oss"
	// Model is the model object of sys_oss.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sys_oss.
	Columns = struct {
		Id          string //           
        Url         string // URL地址   
