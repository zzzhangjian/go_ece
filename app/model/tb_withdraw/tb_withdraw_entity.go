...
// Entity is the golang structure for table tb_withdraw.
type Entity struct {
    Id            uint64      `orm:"id,primary"      json:"id"`              //                       
    UserId        int64       `orm:"user_id"         json:"user_id"`         // 用户ID                
    UserAccountId int64       `orm:"user_account_id" json:"user_account_id"` // 账户ID                
    Currency      string      `orm:"currency"        json:"currency"`        // 提现币种              
    FromAddress   string      `orm:"from_address"    json:"from_address"`    // 提出地址              
    Fee           float64     `orm:"fee"             json:"fee"`             // 手续费                
    Amount        float64     `orm:"amount"          json:"amount"`          // 提现金额              
    Total         float64     `orm:"total"           json:"total"`           // 总额                  
    ToAddress     string      `orm:"to_address"      json:"to_address"`      // 提入地址              
    Txid          string      `orm:"txid"            json:"txid"`            // 提现交易hash          
    BlockNumber   int64       `orm:"block_number"    json:"block_number"`    //                       
    Status        string      `orm:"status"          json:"status"`          // FAIL;PROCESS;SUCCESS  
    Approve       int         `orm:"approve"         json:"approve"`         // 审核状态              
    AasmStatus    string      `orm:"aasm_status"     json:"aasm_status"`     // FAIL;PROCESS;SUCCESS  
    Tid           string      `orm:"tid"             json:"tid"`             // 交易号                
    DoneAt        *gtime.Time `orm:"done_at"         json:"done_at"`         // 完成时间              
