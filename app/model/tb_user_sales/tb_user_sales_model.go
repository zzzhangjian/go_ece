...
// arModel is a active record design model for table tb_user_sales operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_user_sales.
	Table = "tb_user_sales"
	// Model is the model object of tb_user_sales.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_user_sales.
	Columns = struct {
		Id            string //           
        UserId        string // 用户      
        BookingId     string // 排单id    
        SourceUserId  string // 下单用户  
        Amount        string // 业绩金额  
        Total         string // 累计业绩  
        Deleted       string //           
        UpdateAt      string //           
