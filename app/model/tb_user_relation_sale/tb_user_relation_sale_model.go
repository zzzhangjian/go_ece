...
// arModel is a active record design model for table tb_user_relation_sale operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_user_relation_sale.
	Table = "tb_user_relation_sale"
	// Model is the model object of tb_user_relation_sale.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_user_relation_sale.
	Columns = struct {
		Id            string // 主键        
        UserId        string // 用户ID      
        UserParentId  string // 上级用户ID  
        SubLeft       string // 左边业绩    
        SubLeftNum    string //             
        SubRight      string // 右边业绩    
        SubRightNum   string //             
        SaleTotal     string // 业绩        
        CreateTime    string //
	}{
        ...
        SubLeft:      "sub_left",        
        SubLeftNum:   "sub_left_num",    
        SubRight:     "sub_right",       
        SubRightNum:  "sub_right_num",   
