...
// arModel is a active record design model for table tb_transfer operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_transfer.
	Table = "tb_transfer"
	// Model is the model object of tb_transfer.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_transfer.
	Columns = struct {
		Id            string //                       
        Currency      string // 币种                  
        TradeLogFrom  string // 转出地址              
        TradeLogTo    string // 转入地址              
        Fee           string // 手续费                
        Amount        string // 提现金额              
        Total         string // 总额                  
