...
// arModel is a active record design model for table tb_user_machine operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_user_machine.
	Table = "tb_user_machine"
	// Model is the model object of tb_user_machine.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_user_machine.
	Columns = struct {
		Id             string //                                                   
        UserId         string // 用户                                              
        MachineId      string // 矿机                                              
        Price          string // 价格 usdt                                         
        PriceExchange  string // ec.usdt兑换率                                     
        Num            string // 购买数量                                          
        Amount         string // 花费总金额 ec.usdt                                
        Leverage       string // 杠杆率                                            
        ProfitTotal    string // 放大权益 rmb=amount*price*exchange_rate*leverage  
        ProfitRate     string // 每日分红比例                                      
        IsMiner        string // 是否已经计算权益 0:否 1:是                        
        Status         string // SUCCESS,FAIL,PROCESS                              
        CreateAt       string //
	}{
		Id:            "id",              
        UserId:        "user_id",         
