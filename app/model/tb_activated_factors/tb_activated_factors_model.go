...
// arModel is a active record design model for table tb_activated_factors operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_activated_factors.
	Table = "tb_activated_factors"
	// Model is the model object of tb_activated_factors.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_activated_factors.
	Columns = struct {
		Id            string //                     
        UserId        string //                     
        ActivateType  string // EMAIL,PHONE,GOOGLE  
        OtpSecret     string //                     
        Activated     string //                     
        RefreshedAt   string //                     
        LastVerifyAt  string //
