...
// arModel is a active record design model for table tb_trade_log operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_trade_log.
	Table = "tb_trade_log"
	// Model is the model object of tb_trade_log.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_trade_log.
	Columns = struct {
		Id             string // 交易序号                                               
        UserId         string // 用户                                                   
        UserAccountId  string // 入账账户ID                                             
        AccountSymbol  string // 账户类型  wallet, consume, pool, digital, token        
        Currency       string // USDT,ECUSDT,ECE,IECE                                   
        Fee            string // 交易手续费                                             
        Amount         string // 交易金额                                               
        Total          string // 交易总额 = 交易金额 + 手续费                           
        TotalAfter     string // 交易后金额=交易前+交易金额                             
        TradeType      string // 交易类型withdraw,deposit,profit,transfer,exchange,buy  
        ProfitType     string // machine,block,manage,fans,achievement,recommend        
        SourceId       string // 源ID                                                   
        TradeStatus    string // FAIL,PROCESS,SUCCESS                                   
        Bound          string // in_bount,out_bound                                     
        UpdateAt       string //                                                        
        CreateAt       string //
	}{
		Id:            "id",               
