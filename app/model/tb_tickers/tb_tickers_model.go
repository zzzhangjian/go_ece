...
// arModel is a active record design model for table tb_tickers operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_tickers.
	Table = "tb_tickers"
	// Model is the model object of tb_tickers.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_tickers.
	Columns = struct {
		Id          string // 主键                        
        Symbol      string // 交易对                      
        Open        string // 开盘价                      
        ...
        High        string // 最高价                      
        Low         string // 最低价                      
        Rate        string // 长跌幅 close/open           
        Vol         string // 交易量                      
        Amount      string // 以基础币种计量的交易量      
        Count       string // 交易次数（以滚动24小时计）  
