...
// arModel is a active record design model for table tb_machine operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tb_machine.
	Table = "tb_machine"
	// Model is the model object of tb_machine.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tb_machine.
	Columns = struct {
		Id          string //               
        Name        string // 名称          
        Content     string // 详情          
