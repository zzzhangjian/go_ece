...
// arModel is a active record design model for table schedule_job_log operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of schedule_job_log.
	Table = "schedule_job_log"
	// Model is the model object of schedule_job_log.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table schedule_job_log.
	Columns = struct {
		LogId       string // 任务日志id                      
        JobId       string // 任务id                          
        BeanName    string // spring bean名称                 
        Params      string // 参数                            
        Status      string // 任务状态    0：成功    1：失败  
        Error       string // 失败信息                        
